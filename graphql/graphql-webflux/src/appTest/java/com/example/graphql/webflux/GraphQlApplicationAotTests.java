...
//	@Test
//	void getProjectUsingRSocket(@ApplicationUrl(scheme = ApplicationUrl.Scheme.WEBSOCKET) URI applicationUrl) {
//		URI uri = URI.create(applicationUrl.toString() + "/graphql");
